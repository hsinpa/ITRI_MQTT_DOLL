...
export const MaterialAudioPair = new Map<string, string> ([
    ...
    // [MQTT_Action_Name.pat_back_left, AudioEventValue.Event005_翻身教材左翻],
    // [MQTT_Action_Name.pat_back_right, AudioEventValue.Event006_翻身教材右翻]
...
export const TrainingStartAudioPair = new Map<string, string> ([
    ...
    // [MQTT_Action_Name.pat_back_left, AudioEventValue.Event008_左翻抬手動作開始],
    // [MQTT_Action_Name.pat_back_right, AudioEventValue.Event026_右翻抬手動作開始]
]);
